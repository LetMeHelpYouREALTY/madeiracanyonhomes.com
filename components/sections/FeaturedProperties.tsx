...
const properties: Property[] = [
  ...
  },
  {
    ...
    price: "$625,000",
    image: "/images/hero/henderson-style-modern-home-curb-appeal.jpg",
    bedrooms: 3,
    bathrooms: 2,
    squareFeet: 2400,
  },
  {
    ...
    price: "$1,200,000",
    image: "/images/hero/southwest-luxury-home-exterior-pool.jpg",
    bedrooms: 5,
    bathrooms: 4,
    squareFeet: 4500,
  },
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <Button asChild variant="outline" className="mt-4 md:mt-0">
            <a href="https://drjanduffy.realscout.com/" target="_blank" rel="noopener noreferrer">Browse All Homes</a>
          </Button>
        </div>
