  ...
  return (
    <>
      ...
      <PageHero
        ...
        subtitle={"When you list with Berkshire Hathaway HomeServices , you get world-class marketing, expert pricing, and a name that buyers trust. Dr. Jan Duffy has been serving Las Vegas since 2008—helping sellers achieve top-dollar…"}
