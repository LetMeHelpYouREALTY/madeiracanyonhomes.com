...
const schools: SchoolOption[] = [
  ...
  {
    name: "Pinecrest Academy Inspirada",
    grades: "K–8",
    city: "Henderson, NV (2840 Via Contessa)",
    type: "Tuition-free public charter",
    note: "Nearby charter campus in the Inspirada corridor (ZIP 89044). Application and lottery apply — not automatic with a Madeira Canyon address. Other Pinecrest campuses exist separately.",
    ratings: "Check Niche / GreatSchools for the current campus profile",
    sourceUrl: "https://pinecrestinspirada.org/",
    relation: "nearby",
  },
];
